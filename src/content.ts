...
export const internetPainPoints: {
  ...
  },
  {
    ...
    trigger: 'Outdoor coils and cabinets, plus indoor components in a metalworking or chemical-use garage, face a more aggressive atmosphere than a typical residence.',
...
export const sources = [
  ...
  {
    group: 'Garage separation and ventilation',
    title: 'EPA single-family renovation indoor-air guidelines',
  ...
  {
    group: 'Electrical readiness',
    title: 'DOE Alternative Fuels Data Center EV planning guidance',
    href: 'https://afdc.energy.gov/vehicles/electric-fleets',
  },
  {
    group: 'Battery charging',
    title: 'CPSC e-bike battery testing and charging-temperature report',
    href: 'https://www.cpsc.gov/s3fs-public/CPSC-Staff-Statement-on-e-Bike-Battery-Testing-and-Exponent-Report.pdf',
  },
  {
    group: 'Battery charging',
    title: 'CPSC micromobility battery charging safety',
    href: 'https://www.cpsc.gov/node/65775',
  },
  {
    group: 'Refrigerants and installation',
    title: 'EPA HFC phasedown frequently asked questions',
    href: 'https://www.epa.gov/hfcs/frequent-questions-phasedown-hydrofluorocarbons',
  },
  {
    group: 'Heat-pump water heaters',
    title: 'DOE-supported cold-climate heat-pump water-heater field study',
    href: 'https://heatpumpdata.energy.gov/system/files/files/cchp-2025-02/heat-pump-water-heaters-cold-climates_0.pdf',
  },
  {
    group: 'Humidity and low-temperature operation',
    title: 'ENERGY STAR dehumidifier guidance',
    href: 'https://www.energystar.gov/products/dehumidifiers',
  },
  {
    group: 'Conditional radon screening',
    title: 'EPA guidance on when to retest for radon',
    href: 'https://www.epa.gov/radon/how-often-should-i-testretest-my-home-radon',
  },
  {
    group: 'Flood and standing-water exposure',
    title: 'FEMA urban flooding guidance for homeowners and renters',
    href: 'https://www.fema.gov/sites/default/files/documents/fema_urban_flooding_guidance_for_homeowners_and_renters.pdf',
  },
  {
    group: 'Air movement',
    title: 'ENERGY STAR ceiling fan basics',
    href: 'https://www.energystar.gov/products/ceiling_fans/ceiling_fan_basics',
  },
  {
    group: 'Accessible planning',
    title: 'U.S. Access Board EV charging design recommendations',
    href: 'https://www.access-board.gov/tad/ev/',
  },
  {
    group: 'Use and building boundary',
    title: 'ICC residential building-planning provisions',
