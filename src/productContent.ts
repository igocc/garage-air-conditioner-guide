...
export const scenarioJourneys: ScenarioJourney[] = [
  ...
  },
  {
    ...
    products: ['M1', 'M2'],
    boundary: 'Do not connect garage return air to the living-space HVAC system. Keep garage conditioning independent.',
    ownership: 'Leave service clearance around the indoor unit, wash filters on schedule, and preserve access to the drain and outdoor unit.',
  },
  {
    id: 'wood-shop',
    label: 'Wood shop',
    ...
    ownership: 'Treat filter care as part of shop cleanup. Stop and correct the source-control problem if visible dust reaches the indoor unit.',
  },
  {
    ...
    ownership: 'Keep air paths open around stored items, monitor humidity, and inspect for condensation at cold surfaces and supply-air targets.',
  },
  {
    id: 'rental-hoa',
    label: 'Rental / HOA',
